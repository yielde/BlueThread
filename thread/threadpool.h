...
public:
  ...
  public:
    TPHandle(HeartbeatMap *hbmap, heartbeat_handle *hb, duration grace,
             duration suicide_grace)
...
public:
  ThreadPool(HeartbeatMap *hbmap, std::string nm, std::string tn, int n,
             duration grace, duration suicide_grace);
  ~ThreadPool();
  void lock() { _lock.lock(); }
  void unlock() { _lock.unlock(); }
  void wait(BlueConditionVariable &c) {
